...
这需要\textbf{群作用}（group action）的语言。群 $G$ \textbf{作用在}集合 $X$ 上，
...
两个关键概念：
\begin{itemize}
  \item \textbf{轨道}（orbit）：$G \cdot \tau = \{\gamma(\tau) \mid \gamma \in G\}$，
